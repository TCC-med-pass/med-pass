...
VALUES
('João Silva','M','joao@email.com','12345678900','$senha','paciente','11999999999'),

('Maria Souza','F','maria@email.com','98765432100','$senha','medico','11988888888')
";
...
(fk_usuario_id, alergias, tipo_sanguineo, numero_de_carteirinha,
historico_familiar, data_nascimento, rua, numero_casa,
bairro, cidade, altura, peso, contato_emergencia)
...
(nome, caminho, descricao, anexo, tipo,
data_emissao, data_validade, status,
fk_paciente_id, fk_medico_id)
...
(nome, dosagem, frequencia,
data_inicio, data_fim, observacao,
fk_medico_id, fk_paciente_id)
...
(nome, status, tipo, data,
fk_paciente, fk_medico)
